...
from periodic.backward_tracing import recursive as re
...
def main():
    ...
    recursive_bct_test(parameters.ConstantParameters(), 'bct_re_constant_p05')
    print('Running simulation BCT with constant parameters and p=0.0')
    recursive_bct_test(parameters.ConstantParameters(p=0), 'bct_re_constant_p0')
    print('Running simulation BCT with constant parameters and p=1.0')
    recursive_bct_test(parameters.ConstantParameters(p=1), 'bct_re_constant_p1')

    print('Running simulation BCT with variable parameters and p=0.5')
    recursive_bct_test(parameters.VariableParameters(), 'bct_re_variable_p05')
    print('Running simulation BCT with variable parameters and p=0.0')
    recursive_bct_test(parameters.VariableParameters(p=0), 'bct_re_variable_p0')
    print('Running simulation BCT with variable parameters and p=1.0')
    recursive_bct_test(parameters.VariableParameters(p=1), 'bct_re_variable_p1')
